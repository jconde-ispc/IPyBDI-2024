...
--
-- Host: localhost    Database: w3schoolsSQL
-- ------------------------------------------------------
...
INSERT INTO `Categories` VALUES (1,'Beverages','Soft drinks, coffees, teas, beers, and ales'),(2,'Condiments','Sweet and savory sauces, relishes, spreads, a'),(3,'Confections','Desserts, candies, and sweet breads'),(4,'Dairy Products','Cheeses'),(5,'Grains/Cereals','Breads, crackers, pasta, and cereal'),(6,'Meat/Poultry','Prepared meats'),(7,'Produce','Dried fruit and bean curd'),(8,'Seafood','Seaweed and fish');
...
CREATE TABLE `Products` (
  ...
  CONSTRAINT `fk_Products_2` FOREIGN KEY (`SupplierID`) REFERENCES `Suppliers` (`SupplierID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'w3schoolsSQL'
--
...
-- Dump completed on 2019-03-14 16:07:00
